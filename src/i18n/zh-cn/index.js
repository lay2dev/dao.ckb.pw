export default {
  ...
  phase_alert: {
    1: "",
    2: "注意：需要等待 {blocks} 个区块（约 {days} 天 {hours} 小时）才能进行提现操作",
    3: "注意：需要等待 {blocks} 个区块（约 {days} 天 {hours} 小时）才能进行提现操作",
    4: "注意: 距离本补偿周期结束还有 {blocks} 个区块（约 {hours} 小时），请确保交易在本周期结束前上链，否则您需要再等待 30 天才能完成提现操作",
    5: "",
    6: "",
    7: ""
  }
